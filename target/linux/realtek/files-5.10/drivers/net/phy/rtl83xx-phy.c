...
static void rtl8380_rtl8214fc_power_set(struct phy_device *phydev, int port, bool on)
{
	...
	if (on) {
		phy_modify_paged(phydev, RTL821X_PAGE_POWER, 0x10, 1 << 11, 0);
	} else {
		phy_modify_paged(phydev, RTL821X_PAGE_POWER, 0x10, 0, 1 << 11);
	}
...
{
	rtl8380_rtl8214fc_power_set(phydev, PORT_MII, false);
	rtl8380_rtl8214fc_power_set(phydev, PORT_FIBRE, false);
...
static int rtl8214fc_resume(struct phy_device *phydev)
{
	if (rtl8380_rtl8214fc_media_is_fibre(phydev)) {
		rtl8380_rtl8214fc_power_set(phydev, PORT_MII, false);
		rtl8380_rtl8214fc_power_set(phydev, PORT_FIBRE, true);
	} else {
		rtl8380_rtl8214fc_power_set(phydev, PORT_FIBRE, false);
		rtl8380_rtl8214fc_power_set(phydev, PORT_MII, true);
	}
